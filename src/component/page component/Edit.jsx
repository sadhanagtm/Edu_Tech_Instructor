...
const handleImageChange=()=>{
  ...
  return (
    <div>
 <div className=' h-full sm:flex sm:flex-row gap-8 flex flex-col sm:justify-center sm:mt-16 mt-20 mx-4 lg:ml-40  '>

 <div className='sm:h-100 h-fit w-full  px-4 py-4  lg:ml-16 sm:my-16 my-2  bg-white shadow-2xl border border-blue-300 rounded-2xl'>
...
<div className='sm:text-3xl font-semibold text-center text-xl pt:4 '>Update Profile
</div>
...
<div className='  text-center'>Required*</div>
 ...
 <div className=' gap-8  sm:flex sm:flex-row flex flex-col mt-16 sm:my-16 '>
<div className=' '>
...
<div className=' flex flex-col  sm:grid gap-2  sm:mt-7 relative  bottom-5 sm:bottom-0 '>
...
<button className='h-11 w-48 bg-green-600 font-semibold shadow-2xl text-center rounded-3xl my-6'>Update Profile</button>
</div>
