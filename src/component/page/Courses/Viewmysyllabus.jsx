...
function Viewmysyllabus() {
  ...
  const getdata = (courseId, syllabusId) => {
    try {
      axios
        .get(`/course/${courseId}/syllabus/${syllabusId}/`) // Correct API endpoint
        .then((res) => {
          console.log(res);
  ...
  return (
    <div className="h-full lg:ml-52 pb-10 mt-20 flex flex-col">
      <div className="bg-white shadow-2xl border border-red-100 mt-1 prifont font-semibold lg:mx-4 py-2 hover:bg-zinc-50 item-center h-10 rounded-xl text-center">
